...
export const cards = [
    // closeeye - 闭目 x3
    { name: "闭目", type: "初始", cost: 1, effects: { hp: 5, kn: -5 } },
    { name: "闭目", type: "初始", cost: 1, effects: { hp: 5, kn: -5 } },
    { name: "闭目", type: "初始", cost: 1, effects: { hp: 5, kn: -5 } },
    // mouse - 鼠标点击 x3
    { name: "鼠标点击", type: "初始", cost: 1, effects: { attack: 4 } },
    { name: "鼠标点击", type: "初始", cost: 1, effects: { attack: 4 } },
    { name: "鼠标点击", type: "初始", cost: 1, effects: { attack: 4 } },
    // coffe - 咖啡 x3
    { name: "咖啡", type: "增益", cost: 0, effects: { focus: 2, kn: -10 } },
    { name: "咖啡", type: "增益", cost: 0, effects: { focus: 2, kn: -10 } },
    { name: "咖啡", type: "增益", cost: 0, effects: { focus: 2, kn: -10 } },
    // timemanager - 时间管理 x3
    ...
    { name: "时间管理", type: "增益", cost: 2, effects: { energy: 1, kn: -5 } },
    // operate - 操作 x3
    { name: "操作", type: "事件", cost: 1, effects: { attack: 8, hp: 8 } },
    { name: "操作", type: "事件", cost: 1, effects: { attack: 8, hp: 8 } },
    { name: "操作", type: "事件", cost: 1, effects: { attack: 8, hp: 8 } },
    // crazy - 疯狂 x3
    { name: "疯狂", type: "增益", cost: 3, effects: { focus: 10, kn: -5 } },
    { name: "疯狂", type: "增益", cost: 3, effects: { focus: 10, kn: -5 } },
    { name: "疯狂", type: "增益", cost: 3, effects: { focus: 10, kn: -5 } },
    // putoff - 拖延 x3
    { name: "拖延", type: "增益", cost: 3, effects: { attack: 6, kn: 15 } },
    { name: "拖延", type: "增益", cost: 3, effects: { attack: 6, kn: 15 } },
    { name: "拖延", type: "增益", cost: 3, effects: { attack: 6, kn: 15 } }
];
